...
const GROUP_COLORS: Record<string, string> = {
  Principal: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',
  Eleitoral: 'bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300',
  Gabinete: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
  Legislativo: 'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300',
  Politico: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300',
  Comunicacao: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
}
